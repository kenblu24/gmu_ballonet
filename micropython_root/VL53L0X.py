'''
Micropython Library to allow for basic operation of the VL53L0X on the ESP32
...
class VL53L0X:
    def __init__(self, i2c, address=0x29):
        self.DEVICE_TYPE = 'VL53L0X_polulu'
        self.i2c = i2c
    ...
    def set_Vcsel_pulse_period(self, type, period_pclks):
        ...
        if type == self.vcsel_period_type[0]:
            ...
            new_msrc_timeout_mclks = self.timeout_microseconds_to_Mclks(self.timeouts["msrc_dss_tcc_us"],
                                                                        period_pclks)
            self._register(MSRC_CONFIG_TIMEOUT_MACROP, 255 if new_msrc_timeout_mclks >
                           256 else (new_msrc_timeout_mclks - 1))
